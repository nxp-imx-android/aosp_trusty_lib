...
$(MODULE_RSOBJS): MODULE_RUSTDOC_OUT_DIR := $(TRUSTY_SDK_LIB_DIR)/doc
$(MODULE_RSOBJS): MODULE_RUSTDOCFLAGS := $(MODULE_RUSTFLAGS_PRELINK)
...
$(BUILDDIR)/%: RUSTDOC := $(RUST_BINDIR)/rustdoc
