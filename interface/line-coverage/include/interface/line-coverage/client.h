...
/*
This defines the messages exchanged between the non-secure world coverage controller
and the secure world coverage TA (aggregator). Coverage controller connects to the TA
and then uses that connection for sending coverage records.
*/
